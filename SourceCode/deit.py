...
class vit_models(nn.Module):
    ...
    with slight modifications
    """
    def __init__(self, img_size=64,  patch_size=16, in_chans=5, num_classes=2, embed_dim=768, depth=12,
...
@register_model
def deit_tiny_patch16_LS(pretrained=False, img_size=64, pretrained_21k = False,   **kwargs):
    model = vit_models(
        img_size = img_size, patch_size=16, embed_dim=192, depth=5, num_heads=3, mlp_ratio=2, qkv_bias=True,
